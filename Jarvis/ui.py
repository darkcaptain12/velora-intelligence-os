...
class JarvisUI:
    ...
    def _build_social_bar(self):
        ...
        def _open(url):
            return lambda e: _sp.run(["open", url], check=False)
...
"""
    ...
    def _create_desktop_shortcut(self):
        def _run():
            try:
                ...
                self.write_log("SYS: Masaüstü kısayolu oluşturuldu → JARVIS.app")
    ...
    def _draw(self):
        ...
        c.create_text(W-18, H-13, fill=C_DIM, font=font_body(9),
                      text="[F4] MUTE  [F5] PAUSE  [F6] CAM  [⌘F] FULLSCREEN  [ESC] EXIT/WINDOWED", anchor="e")
