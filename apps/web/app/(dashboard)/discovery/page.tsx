  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">🎯 Ürün Keşif Merkezi</h1>
          <p className="text-muted-foreground">
            Satacak ürün bulma motoru. Fırsatlar <strong>Priority Score</strong>'a göre sıralı
            (Opportunity + Validation + Seasonality). Önce fırsat, sonra tasarım.
          </p>
        </div>
                ...
                <CardContent className="flex flex-wrap items-center gap-4 p-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <form action={convertToDesign}>
                      <input type="hidden" name="id" value={o.id} />
                      <Button type="submit" size="sm" disabled={!canDesign} className="w-full" title={canDesign ? '' : 'Validation ≥ 60 gerekli'}>
                        Tasarıma Dönüştür
                      </Button>
                    </form>
                    {!canDesign && (
